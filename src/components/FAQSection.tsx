...
export default function FAQSection() {
  return (
    <section id="faq" className="section-shell bg-black py-20 sm:py-28">
      <Container>
        <SectionHeading
          eyebrow="FAQ"
          title="Questions executives ask before changing operations."
          align="center"
        />
        <div className="mx-auto mt-12 grid max-w-4xl gap-3">
          {FAQS.map((faq) => (
            <details
              key={faq.q}
              className="group rounded-3xl border border-white/[0.08] bg-white/[0.035] p-5 open:bg-[#111111]"
            >
