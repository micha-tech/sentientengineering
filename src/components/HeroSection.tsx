...
export default function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden bg-black pt-28 sm:pt-32 lg:min-h-[92vh] lg:pt-36">
      <div className="absolute inset-0 -z-10 hairline-grid opacity-35" />
        ...
        <div className="grid gap-12 lg:grid-cols-[1.04fr_0.96fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#outcomes"
                className="inline-flex min-h-[3.25rem] items-center justify-center rounded-full border border-white/[0.12] bg-white/[0.03] px-6 text-sm font-semibold text-white transition hover:bg-white/[0.07]"
              >
          ...
          <div className="premium-card overflow-hidden rounded-lg">
            <div className="relative aspect-[4/3] sm:aspect-[16/12]">
              ...
              <div className="absolute inset-x-4 bottom-4 sm:inset-x-6 sm:bottom-6">
                <div className="border border-white/[0.1] bg-black/72 p-4 backdrop-blur-md">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    {heroMetrics.map((metric) => (
                      <div
                        key={metric}
                        className="border border-white/[0.08] bg-white/[0.035] px-3 py-3 text-sm font-medium text-white"
                      >
                        {metric}
                      </div>
                    ))}
